  ...
  var Dashboard = function () {
    ...
    Dashboard.prototype.createLineChart1 = function(element, data, xkey, ykeys, labels, lineColors) {
      ...
      Dashboard.prototype.init = function () {
          ...
          //creating area chart
          var $areaData = [
              {y: '2019', a: 180, b: 36, c:21},
              {y: '2020', a: 90, b: 60, c:360},
              {y: '2021', a: 75, b: 240, c:120},
              {y: '2022', a: 30, b: 30, c:30}
          ];
          this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['BIB', 'Portrait', 'Webcam'], ['#fcbe2d', '#02c58d', '#30419b']);

          //creating donut chart
          var $donutData = [
              {label: "Google Drive", value: 1000},
              {label: "Facebook", value: 111},
              {label: "One Drive", value: 0}
          ];
